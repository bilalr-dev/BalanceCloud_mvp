...
- **[Contracts](../contracts/)** - Team contracts and change requests
...
2. Read **[Team Workflow](team/TEAM_WORKFLOW.md)**
3. Check **[Quick API Reference](guides/QUICK_API_REFERENCE.md)**
4. Review **[Testing Guide](guides/TESTING_GUIDE.md)**
...
2. **[Encryption Architecture](architecture/ENCRYPTION_ARCHITECTURE.md)** - Encryption design
3. **[Testing Guide](guides/TESTING_GUIDE.md)** - Testing procedures
